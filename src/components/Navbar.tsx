...
export function Navbar() {
    ...
    const handleDownloadResume = () => {
        const resumeUrl = "https://drive.google.com/file/d/1QKjI_QHgW4tFtjbKGVTFtQQibezA2ZIn/view?usp=sharing"
        const link = document.createElement("a")
        link.href = resumeUrl
        link.download = "HoangHuy_Resume.pdf"
    ...
    return (
        <main className="fixed w-full z-20">
            <Nav>
                ...
                <NavBody>
                    {/* <NavbarLogo /> */}
                    <span className="font-bold   text-2xl  font-sans"> {'{HoangHuy}'} </span>
