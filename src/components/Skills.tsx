...
const skills: Skill[] = [
  ...
  { name: "C#", category: "Programming Languages", icon: <CSharpIcon /> },
  ...
  { name: "ASP.NET", category: "Backend", icon: <ASPNetIcon /> },
  ...
  { name: "Restful", category: "Tools & Platforms", icon: <RESTIcon /> },
];
  ...
  return (
    ...
    >
      <div className=" mx-auto">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-sans font-bold text-center">
            Technical Skills
          </h1>
